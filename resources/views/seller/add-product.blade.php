        ...
        <div class="col-md-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('/seller/store-product') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="location" name="location" placeholder="e.g., Dar es Salaam, Arusha" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <small class="text-muted">Minimum quantity buyers must purchase</small>
                            </div>
                        </div>
